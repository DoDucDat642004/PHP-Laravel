                    ...
                    <div class="blog-sidebar tour-sidebar">
                        ...
                        <div class="widget widget-booking" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <form action="{{ route('booking', ['id' => $tourDetail->tourId]) }}" method="POST">
                                ...
                                <ul class="tickets clearfix">
                                    <li>
                                        Người lớn (18+ tuổi) <span class="price">{{ number_format($tourDetail->priceAdult, 0, ',', '.') }} VND</span>
                                    ...
                                    <li>
                                        Trẻ em (5 - 18 tuổi) <span class="price">{{ number_format($tourDetail->priceChild, 0, ',', '.') }} VND</span>
                                        <select name="18-" id="18-">
                                            <option value="value1">01</option>
                                            <option value="value1">02</option>
                                ...
                                <div class="text-center">
                                    <a href="{{ route('contact') }}">Bạn có cần trợ giúp gì không?</a>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="widget widget-contact" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <ul class="list-style-one">
                                <li><i class="far fa-envelope"></i> <a href="emilto:help@gmail.com">help@gmail.com</a></li>
...
@inculde('clients.blocks.new_letter')
