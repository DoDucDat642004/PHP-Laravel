...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;5')}}00;600;700&amp;display=swap" rel="stylesheet">
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="{{route('client')}}">Pages</a>
                                            <ul>
                                                <li><a href="{{route('client')}}">faqs</a></li>
                                                <li><a href="{{route('contact')}}">Contact Us</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown"><a href="#">blog</a>
                                            <ul>
                                                <li><a href="{{route('client')}}">blog List</a></li>
                                                <li><a href="{{route('client')}}">blog details</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
