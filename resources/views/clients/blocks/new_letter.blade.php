            ...
            <div class="col-lg-6">
                <div class="newsletter-content-part text-white rmb-55" data-aos="zoom-in-right" data-aos-duration="1500" data-aos-offset="50">
                    <div class="section-title counter-text-wrap mb-45">
                        <h2>Đăng ký bản tin của chúng tôi để nhận được nhiều ưu đãi</h2>
                        <p>Website<span class="count-text plus" data-speed="300" data-stop="40">0</span> địa điểm du lịch nổi tiếng</p>
                    </div>
